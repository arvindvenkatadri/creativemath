---
title: <iconify-icon icon="mdi:matrix" width="1.2em" height="1.2em"></iconify-icon> <iconify-icon icon="gravity-ui:function" width="1.2em" height="1.2em"></iconify-icon> Matrix Algebra Whirlwind Tour
subtitle: ""
subject: ""
abstract: ""
date: 12/April/2025
...
library(reticulate)
reticulate::use_virtualenv("creative_math")
library(matlib)
library(caracas)
library(ggformula)
library(armadillo4r)
...
## Transpose
A matrix transpose is accomplished by writing rows as columns and vice versa. Hence an $r~ \times ~ c$ matrix becomes transposed into a $c~ \times ~ r$ matrix, as shown below:
...
Suppose there are three SMI peasants who bought two kinds of food and drink:

- Peasant A: 2 samosas and 1 chai
- Peasant B: 3 samosas and 0 chai
- Peasant C: 0 samosa and 2 chai-s (Just before Arvind's R class.)
...
Shop#2 is cheaper. Drag *Peasant#3* and go there, *Peasant#1* and *Peasant#2*.

...
### Fourier Series: Intuitive

Take a look at this picture below:

```{r}
#| echo: false
#| label: fig-Fourier-smoothie
#| out-width: "80%"
#| fig-cap: "Fourier Series as a Smoothie Recipe. Source: [Better Explained](https://betterexplained.com/articles/an-interactive-guide-to-the-fourier-transform/)"

knitr::include_graphics("https://betterexplained.com/wp-content/webp-express/webp-images/uploads/images/smoothie-to-recipe-20121030-223058.png.webp")
```
Another good way to form this intuition is to play some of the **Wave Game** that is available on the [University of Colorado PHET Simulations website](https://phet.colorado.edu): 

...
The projects below have been grouped into two groups, one for the junior students and the other senior students, who are both paradoxically in the same class. But there is an opinion that [prerequisites are irrelevant](https://x.com/sean_a_mcclure/status/1895213068197450169?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1895213068197450169%7Ctwgr%5Eaa19dc4d6046897671e95fec3f61ec8e92eae0b7%7Ctwcon%5Es1_c10&ref_url=http%3A%2F%2Flocalhost%3A4040%2Fcontent%2Fcourses%2FMathModelsDesign%2FModules%2F1000-Projects%2Findex.html%3Fcapabilities%3D1host%3Dhttp3A2F2F127.0.0.13A34775). 

>> Do not start with fundamentals. This is an awful approach to learning. 
Start with so-called "advanced" topics and ask questions until every term/concept is understood. This is the correct, rigorous, scientific way to learn, because the advanced topics are embedded in larger, more convoluted, more abstracted constructs. This embedding is what gives the individual pieces their *meaning*. Foundational studies have removed this embedding, and present only the isolated, sterile pieces. They have no meaning. They have no context. <snip>
...
-   Link the [IFTTT app](https://play.google.com/store/apps/details?id=com.ifttt.ifttt&hl=en) to p5.js using for instance [OSC messages](../500-Tech/50-OSC/index.qmd), and make things happen over WiFi, from other classes or buildings
